...
public class ModelOctollagerTentacle extends EntityModel<EntityOctollagerClaw>
{
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(VillageandVillagers.MODID, "tentacle"), "main");
	private final ModelPart root;

	public ModelOctollagerTentacle(ModelPart root) 
	{
